...
func (m *MockUserRepository) FindByName(arg0 context.Context, arg1 string) (*user.User, error) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) Store(arg0 context.Context, arg1 *user.User) error {
	m.ctrl.T.Helper()
